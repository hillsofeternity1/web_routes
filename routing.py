        ...
        if (request.form['gateway'] and request.form['number']):
            try:
                ...
                if request.form['action'] == 'Add':
                    output = execute((_add_gateway_for_table % (request.form['gateway'], request.form['number'])))
                else:
                    output = execute((_del_gateway_for_table % (request.form['gateway'], request.form['number'])))
                if output != '':
                    message = output
                else:
